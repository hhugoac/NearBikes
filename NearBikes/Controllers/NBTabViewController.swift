...
class NBTabViewController: UITabBarController {
    ...
    private func setupTabs() {
        let listBikesVC = NBListBikesViewController()
        ...
        nav1.tabBarItem = UITabBarItem(title: "List of bikes avalable", image: UIImage(systemName: "globe"), tag: 1)
        nav2.tabBarItem = UITabBarItem(title: "Settings", image: UIImage(systemName: "globe"), tag: 2)
